...
files <- col_files(searchpath="~/NGS/BD/7-31-14/rep2", mypattern="unpaired_mult.sort.bam$")

cat("bedtools multicov -bams",
    files[1:12],
    "-bed CBF_8genes.bed > cbf_rc_multi.txt",
    file="~/NGS/BD/7-31-14/CBF3/multi_rc.sh", sep=" "
    )
